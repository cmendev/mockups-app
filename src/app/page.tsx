      ...
      <div className="bg-right bg-cover">
        <div className="container md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            <h1 className="text-3xl md:text-5xl text-indigo-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Welcome to Pro<span className="bg-accent">Stock</span></h1>
